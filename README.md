 ...
 * Similar to slinger rush.
 * Civilization: all archer civilizations:
   Carthagenians, Kushites, Mauryas, Persians
 * Consider using when:
   * Opponent can produce ranged units with a shorter range
     from its civic center; i.e. javelineers and slingers: 
...
> You (an archer civilization) having equal (`.`),
> better (`+`) or way better (`++`) range than the opponent
 ...
 * Consider using when:
   * Opponent can produce ranged units with a shorter range
     from its civic center; i.e. javelineers: 
     Gauls, Iberians, Macedonians, Romans, Seleucids, Spartans
   * There is few hunt close the civic center
 * Avoid using when:
   * Opponent can produce ranged units with a longer range
     from its civic center; i.e. archers: 
     Carthagenians, Kushites, Mauryas, Persians
   * There is a lot of hunt close to the civic center
...
## Ranges of civic centers' ranged units

Civic center ranged unit|Range
------------------------|------------------------
Archers                 |60
Crossbowmen             |45
Javalineers             |30
